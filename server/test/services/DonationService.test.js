const DonationService = require("../../lib/services/DonationService");
...
describe("DonationService tests", () => {
    ...
    test("Create Donation", async () => {
        ...
        const donationCreated = await DonationService.getDonationByID(theID);
    ...
    test ("Update Donation", async () => {
        ...
        await DonationService.updateDonation(theID, updatedData);

        const updatedDonation = await DonationService.getDonationByID(theID);
    ...
    test("Delete Donation", async () => {
        await DonationService.deleteDonation(theID);

        const response = await DonationService.getDonationByID(theID);

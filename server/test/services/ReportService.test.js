...
describe("ReportService tests", () => {
    ...
    test("Create Report", async () => {
        ...
        const reportCreated = await ReportService.getReportByID(theID);
    ...
    test ("Update Report", async () => {
        ...
        await ReportService.updateReport(theID, updatedData);

        const updatedReport = await ReportService.getReportByID(theID);
    ...
    test("Delete Report", async () => {
        await ReportService.deleteReport(theID);

        const response = await ReportService.getReportByID(theID);
